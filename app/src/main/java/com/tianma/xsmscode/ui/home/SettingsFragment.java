...
public class SettingsFragment extends BasePreferenceFragment implements
    ...
    protected void doOnCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (cfgEntry != null) {
            cfgEntry.setOnPreferenceClickListener(p -> {
                ...
                com.tianma.xsmscode.ui.forward.ChannelSettingsDialog.showDialog(getChildFragmentManager(), ch);
                return true;
            });
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (PrefConst.KEY_HIDE_LAUNCHER_ICON.equals(key)) {
            ...
            com.tianma.xsmscode.ui.forward.ChannelSettingsDialog.showDialog(getChildFragmentManager(), (String) newValue);
        } else {
            return false;
        }
        return true;
